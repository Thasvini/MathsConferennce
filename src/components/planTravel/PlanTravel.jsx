  ...
  return (
    ...
    <div className='travelplan'>
      ...
      <ul>
        ...
        <li>The value of “pi” was first calculated by the Indian Mathematician Aryabhat, and he explained the concept of what is known as the Pythagorean Theorem.</li>
        <li>Algebra, Trigonometry and Calculus are also originated in India.</li>
